...
xychart-beta
  ...
  x-axis ["eth_blockNumber", "eth_getBlockByHash", "eth_getBlockByNumber(fullTx=false)", "eth_getBlockByNumber(fullTx=true)", "eth_getLogs", "eth_getTransactionByBlockNumberAndIndex", "eth_getTransactionByHash", "eth_getTransactionReceipt", "trace_block", "trace_transaction"]
  y-axis "ms"
  bar "wrapper" [39.3, 62.81, 216.27, 146.16, 55.9, 147.85, 44.69, 49.22, 322.43, 52.55]
  bar "rpc" [64.21, 57.25, 48.48, 115.44, 44.15, 50.66, 54.94, 51.78, 245.01, 46.75]
```
...
xychart-beta
  ...
  x-axis [1, 5, 10, 25, 1000, 10000]
  y-axis "ms"
  bar "wrapper" [91.64, 83.82, 80.51, 90.55, 139.79, 438.53]
  bar "rpc" [43.35, 47.94, 54.4, 65.85, 276.57, 3402.79]
```
